...
VALUES ('A7F9G2', 1, 'Wireless Earbuds Pro', 29.99, 39.99, 10, 50, 100, 5, null, null);

INSERT INTO Product (id, vendorid, name, costprice, msrp, rop, eoq, qoh, qoo, qrcode, qrcodetxt) 
VALUES ('Z4X8P3', 2, 'Eco-Friendly Water Bottle', 19.99, 29.99, 15, 30, 200, 10, null, null);

INSERT INTO Product (id, vendorid, name, costprice, msrp, rop, eoq, qoh, qoo, qrcode, qrcodetxt) 
VALUES ('M2Q5K1', 3, 'Smart Home Assistant', 49.99, 69.99, 5, 20, 150, 2, null, null);

INSERT INTO Product (id, vendorid, name, costprice, msrp, rop, eoq, qoh, qoo, qrcode, qrcodetxt) 
VALUES ('R8N7B9', 4, 'Portable Power Bank', 99.99, 129.99, 20, 10, 80, 4, null, null);
